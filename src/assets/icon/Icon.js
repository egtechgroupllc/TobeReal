...
export function IconMapView({fill, ...props}) {
  return (
    <Svg
      ...
      {...props}>
      <Path
        d="M1.462 1.46l2.044 1.598a.75.75 0 01.288.59v8.301a.75.75 0 01-1.211.591L.538 10.942a.75.75 0 01-.288-.59V2.05a.75.75 0 011.212-.591zM9.55 1.46l2.045 1.598a.75.75 0 01.288.59v8.301a.75.75 0 01-1.212.591l-2.044-1.598a.75.75 0 01-.288-.59V2.05A.75.75 0 019.55 1.46zM6.627 1.46L4.583 3.058a.75.75 0 00-.289.59v8.301a.75.75 0 001.212.591l2.045-1.598a.75.75 0 00.288-.59V2.05a.75.75 0 00-1.212-.591z"
        stroke={fill || '#BCBCBC'}
        strokeWidth={0.5}
      />
      <Path
