...
export function IconExplore({fill, ...props}) {
  return (
    <Svg
      ...
      {...props}>
      <G clipPath="url(#clip0_99_2042)" fill={fill || '#000'}>
...
export function IconProfile({fill, ...props}) {
  return (
    <Svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      {...props}>
      <G clipPath="url(#clip0_99_2035)" fill={fill || '#000'}>
  ...
  return (
    <Svg
      ...
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M.44 9.44l4.82-3.042c.24.708.571 1.382.985 2.005l.204.315v9.909l-5.73 3.61a.458.458 0 01-.473 0A.453.453 0 010 21.833v-11.61a.899.899 0 01.433-.784h.008zm12.938-8.045a4.79 4.79 0 00-6.756 0c-1.86 1.856-1.436 4.555 0 6.757l2.822 4.333a.662.662 0 001.112 0l2.823-4.333c1.435-2.202 1.859-4.9 0-6.757zM10 2.665a1.827 1.827 0 110 3.655 1.827 1.827 0 010-3.655zm3.036 6.86l.064.04v12.972l-6.2-3.91V9.43l2.157 3.316a1.125 1.125 0 001.886 0l2.093-3.2v-.02zm.527.04l5.718-3.61a.458.458 0 01.473-.012.454.454 0 01.246.404v11.625a.903.903 0 01-.433.783l-6.004 3.782V9.565z"
        fill={fill || '#000'}
      />
    </Svg>
  );
...
export function IconPromotion({fill, active, ...props}) {
  return (
    <Svg
      width={props?.style?.width || scale(39)}
      height={props?.style?.height || scale(20)}
      viewBox="0 0 39 20"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props}>
      <Path
        d="M29.933.5c.352.542.915.834 1.497.833A1.775 1.775 0 0032.916.5h3.17c.736 0 1.426.687 1.426 1.653v15.694c0 .967-.69 1.653-1.426 1.653h-3.304a1.703 1.703 0 00-1.374-.787 1.695 1.695 0 00-1.471.787H1.927c-.738 0-1.427-.687-1.427-1.653V2.153C.5 1.186 1.19.5 1.926.5h28.007z"
        fill="url(#paint0_linear_99_88)"
        stroke={active ? '#F0B90B' : '#000'}
      />
      <Path
        d="M35.862 19.5h-3.085a1.77 1.77 0 00-.844-.683V1.248c.395-.128.736-.394.974-.747h3.18c.736 0 1.424.685 1.424 1.65V17.85c0 .965-.688 1.65-1.423 1.65h-.224l-.002.001z"
        stroke={active ? '#F0B90B' : '#000'}
      />
      <Path
        d="M22.751 14.67c.042.008.07.05.064.098-.008.046-.046.078-.088.07-.042-.008-.07-.051-.063-.098.007-.046.046-.079.087-.07zM8.893 4.178c.082 0 .148-.074.148-.166 0-.091-.066-.166-.148-.166-.082 0-.148.075-.148.166 0 .092.066.166.148.166zM25.58 13.06c.091 0 .165-.083.165-.184 0-.101-.074-.183-.165-.183-.09 0-.163.082-.163.183 0 .101.073.184.163.184zM8.59 7.912c.078 0 .142-.071.142-.159 0-.088-.064-.16-.143-.16-.078 0-.142.072-.142.16 0 .088.064.16.143.16zM13.377 11.06c.03 0 .053-.026.053-.059s-.023-.06-.053-.06-.053.027-.053.06.024.06.053.06zM15.778 9.522c.074 0 .135-.068.135-.152 0-.083-.06-.15-.135-.15-.075 0-.136.067-.136.15 0 .084.06.152.136.152zM16.586 6.026c0 .101-.073.183-.164.183-.09 0-.164-.082-.164-.183 0-.101.074-.184.164-.184.091 0 .164.083.164.184zM19.229 16.547c.072-.018.143.032.16.114.017.08-.028.161-.101.18-.073.018-.144-.032-.162-.114-.016-.08.03-.16.102-.18zM16.775 12.802c.078-.02.154.036.171.12.017.088-.032.173-.108.192-.078.02-.154-.035-.171-.12-.017-.086.032-.173.108-.192zM16.709 16.93c-.065-.033-.092-.119-.062-.19.03-.07.106-.102.17-.068.063.033.092.119.061.19-.03.072-.106.102-.17.069zM20.302 4.062c-.072.045-.163.015-.201-.064-.04-.08-.013-.182.057-.225.072-.045.163-.015.202.064.04.08.013.182-.058.225zM17.235 2.42a.154.154 0 01-.031.197c-.058.044-.136.028-.176-.035a.153.153 0 01.032-.196c.057-.044.135-.028.175.035zM10.177 10.084c.092 0 .167.084.167.187s-.075.186-.167.186c-.092 0-.167-.083-.167-.186s.075-.187.167-.187z"
        fill="#fff"
      />
      <Path
        d="M9.66 10.271h1.033M10.177 10.849V9.694M9.854 10.631l.632-.704M10.48 10.627l-.62-.695"
        stroke="#fff"
        strokeWidth={0.75}
        strokeMiterlimit={10}
      />
      <Path
        d="M28.517 7.39c.092 0 .166.084.166.187s-.074.187-.166.187c-.093 0-.167-.084-.167-.187s.074-.187.167-.187z"
        fill="#fff"
      />
      <Path
        d="M28 7.578h1.033M28.517 8.155V7M28.194 7.938l.632-.705M28.82 7.933l-.62-.695"
        stroke="#fff"
        strokeWidth={0.75}
        strokeMiterlimit={10}
      />
      <Path
        d="M20.517 11.39c.092 0 .166.084.166.187s-.074.187-.166.187c-.093 0-.167-.084-.167-.187s.074-.187.167-.187z"
        fill="#fff"
      />
      <Path
        d="M20 11.578h1.033M20.517 12.155V11M20.194 11.938l.632-.705M20.82 11.933l-.62-.695"
        stroke="#fff"
        strokeWidth={0.75}
        strokeMiterlimit={10}
      />
      <Path
        d="M19.517 3.39c.092 0 .166.084.166.187s-.074.187-.166.187c-.093 0-.167-.084-.167-.187s.074-.187.167-.187z"
        fill="#fff"
      />
      <Path
        d="M19 3.578h1.033M19.517 4.155V3M19.194 3.938l.632-.705M19.82 3.933l-.62-.695"
        stroke="#fff"
        strokeWidth={0.75}
        strokeMiterlimit={10}
      />
      <Path
        d="M17.293 4.15c.032 0 .058-.03.058-.065 0-.036-.026-.065-.058-.065s-.058.03-.058.065.026.064.058.064zM17.304 17.308c.042.008.07.052.064.099-.008.046-.046.078-.088.07-.042-.008-.07-.051-.064-.098.008-.047.047-.079.088-.07zM3.446 6.817c.082 0 .148-.075.148-.166 0-.092-.066-.166-.148-.166-.082 0-.148.074-.148.166 0 .091.066.166.148.166zM20.134 15.698c.09 0 .164-.082.164-.183 0-.101-.074-.183-.164-.183-.091 0-.165.082-.165.183 0 .101.074.183.165.183zM3.142 10.551c.08 0 .143-.071.143-.16 0-.087-.064-.158-.143-.158-.078 0-.142.07-.142.159 0 .088.064.16.142.16zM7.93 13.7c.03 0 .053-.027.053-.06s-.023-.06-.053-.06-.053.027-.053.06.024.06.053.06zM10.33 12.16c.075 0 .136-.067.136-.15 0-.084-.06-.152-.135-.152-.075 0-.136.068-.136.151 0 .084.06.152.136.152zM11.14 8.665c0 .101-.074.183-.165.183-.09 0-.164-.082-.164-.183 0-.102.074-.184.164-.184.091 0 .164.082.164.184zM13.781 19.186c.072-.018.144.032.162.114.016.08-.03.16-.102.18-.072.018-.144-.032-.162-.114-.015-.08.03-.16.102-.18zM11.328 15.441c.078-.02.154.035.171.12.017.088-.032.173-.108.192-.078.02-.154-.035-.171-.12-.017-.086.032-.173.108-.192zM11.262 19.57c-.065-.034-.092-.12-.062-.19.03-.071.106-.103.17-.07.063.034.092.12.062.19-.03.073-.107.103-.17.07zM14.855 6.701c-.072.045-.163.015-.202-.064-.04-.08-.012-.182.058-.225.072-.045.163-.015.202.064.04.08.012.182-.058.225zM11.788 5.06a.154.154 0 01-.031.196c-.058.044-.136.027-.176-.035a.153.153 0 01.032-.197c.057-.043.135-.027.175.036zM4.73 12.723c.092 0 .167.084.167.187 0 .102-.075.186-.167.186-.092 0-.167-.084-.167-.186 0-.103.075-.187.167-.187z"
        fill="#fff"
      />
      <Path
        d="M4.213 12.91h1.033M4.73 13.488v-1.155M4.407 13.27l.632-.704M5.033 13.266l-.62-.695"
        stroke="#fff"
        strokeWidth={0.75}
        strokeMiterlimit={10}
      />
      <Path
        d="M11.846 6.788c.032 0 .057-.029.057-.064 0-.036-.025-.065-.057-.065s-.058.03-.058.065.026.064.058.064z"
        fill="#fff"
      />
      <Defs>
        <LinearGradient
          id="paint0_linear_99_88"
          x1={1.05588}
          y1={8.85396}
          x2={38.0116}
          y2={8.85396}
          gradientUnits="userSpaceOnUse">
          <Stop stopColor={active ? '#F0B90B' : '#000'} />
          <Stop offset={0.818965} stopColor={active ? '#F0E70B' : '#000'} />
          <Stop
            offset={0.854501}
            stopColor={active ? '#F0E70B' : '#000'}
            stopOpacity={0}
          />
        </LinearGradient>
      </Defs>
