...
export function IconMapView({fill, ...props}) {
  return (
    <Svg
      ...
      {...props}>
      <Path
        d="M14.393 0a4.65 4.65 0 00-4.384 3.11L7.76 2.47a.732.732 0 00-.213-.03.732.732 0 00-.183.03L.534 4.42A.732.732 0 000 5.123V19.27a.732.732 0 00.93.702l6.632-1.898 6.632 1.898c.13.036.267.036.397 0l6.83-1.952a.731.731 0 10-.396-1.402l-5.9 1.692v-6.564c2.377-2.527 3.902-4.756 3.902-7.15v-.038l1.464-.42V14.88a.734.734 0 00.732.743.73.73 0 00.732-.743V3.171a.733.733 0 00-.755-.732.732.732 0 00-.175.03l-2.25.641A4.65 4.65 0 0014.394 0zm0 1.464c1.764 0 3.17 1.398 3.17 3.133 0 1.654-1.128 3.515-3.17 5.763C12.35 8.112 11.22 6.25 11.22 4.597c0-1.735 1.408-3.133 3.171-3.133zm0 .975a2.207 2.207 0 00-2.196 2.196c0 1.204.992 2.195 2.196 2.195a2.207 2.207 0 002.195-2.195 2.207 2.207 0 00-2.196-2.196zm0 1.464c.412 0 .731.319.731.732a.721.721 0 01-.732.732.721.721 0 01-.731-.732c0-.413.319-.732.732-.732zm-7.563.229V16.77l-5.366 1.532V5.672l5.366-1.54zm1.464.007l1.464.42v.038c0 2.394 1.525 4.623 3.903 7.15v6.564l-5.367-1.54V4.139z"
        fill={fill || '#474747'}
      />
    </Svg>
  );
