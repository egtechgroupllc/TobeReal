...
import Svg, {Path, Rect, Defs, Pattern, Use, Image, G, ClipPath, Circle} from 'react-native-svg';
...
export function IconExplore({fill, ...props}) {
  return (
    <Svg
      ...
      {...props}>
      <Path
        d="M.45 15.467a.45.45 0 01-.45-.45V2.429a.45.45 0 01.3-.424L5.936.025a.45.45 0 01.599.425v12.515a.45.45 0 01-.296.423L.604 15.44a.448.448 0 01-.154.027zM.9 2.748v11.626l4.734-1.724V1.085L.9 2.748z"
        fill={fill || COLORS.text}
      />
      <Path
        d="M7.678 14.047a.45.45 0 01-.166-.032l-1.594-.631a.45.45 0 01-.284-.419V.45a.45.45 0 01.604-.423l5.635 2.052a.45.45 0 01.296.423v5.744a.45.45 0 01-.9 0v-5.43L6.534 1.094V12.66l1.31.518a.45.45 0 01-.167.869z"
        fill={fill || COLORS.text}
      />
      <Path
        d="M17.352 13.488a.45.45 0 01-.45-.45V1.093L12.17 2.817v5.429a.45.45 0 01-.9 0V2.502a.45.45 0 01.296-.423L17.199.027a.45.45 0 01.603.423v12.588a.45.45 0 01-.45.45z"
        fill={fill || COLORS.text}
      />
      <Path
        d="M12.499 18.341a5.31 5.31 0 01-5.304-5.303 5.31 5.31 0 015.304-5.304 5.31 5.31 0 015.303 5.304A5.31 5.31 0 0112.5 18.34zm0-9.707a4.409 4.409 0 00-4.404 4.404 4.409 4.409 0 004.404 4.404 4.409 4.409 0 004.404-4.404 4.409 4.409 0 00-4.404-4.404z"
        fill={fill || COLORS.text}
      />
      <Path
        d="M19.55 20.796a.448.448 0 01-.318-.131l-3.68-3.68a.45.45 0 01.636-.637l3.68 3.68a.45.45 0 01-.318.768zM9.58 13.638a.45.45 0 01-.449-.45 3.648 3.648 0 013.644-3.642.45.45 0 010 .9 2.747 2.747 0 00-2.744 2.742.45.45 0 01-.45.45z"
        fill={fill || COLORS.text}
      />
    </Svg>
  );
...
export function IconBookings({fill, ...props}) {
  return (
    <Svg
      ...
      {...props}>
      <Path
        d="M19 0H1C.449 0 0 .449 0 1v18c0 .551.449 1 1 1h18c.551 0 1-.449 1-1V1c0-.551-.449-1-1-1zm0 19.333H1A.334.334 0 01.667 19V3.333h3.666v-.666H.667V1c0-.184.15-.333.333-.333h18c.184 0 .333.15.333.333v1.667h-13v.666h13V19c0 .184-.15.333-.333.333z"
        fill={fill || COLORS.text}
      />
      <Path
        d="M5.667 2.667H5v.666h.667v-.666zM16 1.333h-.667V2H16v-.667zM17.333 1.333h-.666V2h.666v-.667zM18.667 1.333H18V2h.667v-.667zM10.333 14.333v-1.666c0-.552-.448-1-1-1H2.667c-.552 0-1 .448-1 1v1.666a.334.334 0 00-.334.334V18A.333.333 0 002 18v-.333h8V18a.333.333 0 00.667 0v-3.333a.334.334 0 00-.334-.334zm-8-1.666c0-.184.15-.334.334-.334h6.666c.184 0 .334.15.334.334v1.666H9v-1A.333.333 0 008.667 13h-2a.333.333 0 00-.334.333v1h-.666v-1A.333.333 0 005.333 13h-2a.333.333 0 00-.333.333v1h-.667v-1.666zm6 1.666H7v-.666h1.333v.666zm-3.333 0H3.667v-.666H5v.666zM2 15h8v2H2v-2zM3 11c.184 0 .333-.15.333-.333v-.334h5.334v.334a.333.333 0 00.666 0V7.333A.333.333 0 009 7V5.333c0-.551-.449-1-1-1H4c-.551 0-1 .449-1 1V7a.333.333 0 00-.333.333V10.667c0 .184.149.333.333.333zm.333-3.333h5.334v2H3.333v-2zM7 7H5v-.667h2V7zM3.667 5.333C3.667 5.15 3.817 5 4 5h4c.184 0 .333.15.333.333V7h-.666V6a.333.333 0 00-.334-.333H4.667A.333.333 0 004.333 6v1h-.666V5.333zM13 8.333h-1.333a.334.334 0 00-.334.334V10c0 .184.15.333.334.333H13c.184 0 .333-.149.333-.333V8.667A.333.333 0 0013 8.333zm-.333 1.334H12V9h.667v.667zM18.667 6.333H14V7h4.667v-.667zM18.667 9H14v.667h4.667V9zM13 12.333h-1.333a.334.334 0 00-.334.334V14c0 .184.15.333.334.333H13c.184 0 .333-.149.333-.333v-1.333a.333.333 0 00-.333-.334zm-.333 1.334H12V13h.667v.667zM13 15h-1.333a.333.333 0 00-.334.333v1.334c0 .184.15.333.334.333H13c.184 0 .333-.15.333-.333v-1.334A.333.333 0 0013 15zm-.333 1.333H12v-.666h.667v.666zM18.667 13H14v.667h4.667V13zM18.667 15.667H14v.666h4.667v-.666zM13.902 5.098a.333.333 0 00-.471 0l-.569.569h-1.195a.334.334 0 00-.334.333v1.333a.336.336 0 00.334.334H13c.184 0 .333-.15.333-.334V6.138l.57-.569a.333.333 0 000-.471zm-1.707 1.235L12 6.53v-.196h.195zm.472.667h-.196l.196-.195V7z"
        fill={fill || COLORS.text}
      />
    </Svg>
  );
...
export function IconProfile({fill, ...props}) {
  return (
    <Svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      {...props}>
      <G clipPath="url(#clip0_123_1332)" fill="#F0B90B">
        <Path d="M13.308 10.757c-.05.043-.106.087-.157.13l-.165.131c-.114.087-.232.17-.355.25l-2.51 4.825-.5-2.779.74-1.116c-.088.02-.181.035-.27.051a6.691 6.691 0 01-1.113.091 6.91 6.91 0 01-1.499-.166l.754 1.14-.47 2.831-2.781-5.111a6.667 6.667 0 01-.373-.301l-.05.04c-2.71 2.185-3.425 5.558-3.612 7.332h15.79c-.52-5.187-2.828-6.968-3.425-7.344l-.004-.004z" />
        <Path d="M8.973.736c-3.301 0-5.985 2.51-5.985 5.594 0 3.085 2.684 5.599 5.985 5.599 3.302 0 5.986-2.51 5.986-5.599 0-3.088-2.688-5.594-5.986-5.594z" />
      </G>
      <Defs>
        <ClipPath id="clip0_123_1332">
          <Path
            fill="#fff"
            transform="translate(.947 .736)"
            d="M0 0H15.7895V17.3684H0z"
          />
        </ClipPath>
      </Defs>
    </Svg>
