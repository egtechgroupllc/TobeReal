...
export default function QuestionUserScreen() {
    ...
    <MainWrapper
      ...
      <View
        ...
        <Button
          style={{flex: 1}}
          sizeButton="small"
          title={t('make_a_question')}
          linearGradientProps={{
            colors: COLORS.linearButton,
          }}
          onPress={() =>
            navigate('NoBottomTab', {screen: 'MakeQuestionScreen'})
          }
        />
        <Button
          style={{flex: 1}}
          ...
          onPress={() => navigate('NoBottomTab', {screen: 'MyQuestionScreen'})}
        />
      </View>
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          return <QuestionItem data={item} isLoading={isLoading} home={true} />;
        }}
      />
