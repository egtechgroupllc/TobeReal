    ...
    <View style={styles.wrapper}>
      ...
      <WrapperContent
        ...
        <FlatList
          ...
          data={data}
          contentContainerStyle={styles.content}
          renderItem={({item}) => <BoxPlaceItem isDiscount data={item} rental="night" jsonImage={item?.imgdetail} name={item?.name}/>}
        />
      </WrapperContent>
      ...
      <WrapperContent
        ...
        <FlatList
          ...
          contentContainerStyle={styles.content}
          renderItem={({item}) => (
            <BoxPlaceItem isDiscount data={item} rental="night" jsonImage={item?.imgdetail} name={item?.name}/>
          )}
        />
      </WrapperContent>
